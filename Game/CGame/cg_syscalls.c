...
voidtrap_CM_LoadMap(const char *mapname){
...
// this returns a handle.  arg0 is the name in the format "intro.roq", set arg1 to NULL, alteredstates to qfalse (do not alter gamestate)
