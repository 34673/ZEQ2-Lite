...
static qboolean ParseStage( shaderStage_t *stage, char **text )
{
	...
	while ( 1 )
	{
		...
		//
		// clampAnimMap2 <frequency> <image1> .... <imageN>
		//
		...
		//
		// clampAnimMap3 <frequency> <image1> .... <imageN>
		//
		...
		//
		// clampAnimMap4 <frequency> <image1> .... <imageN>
		//
		...
		//
		// clampAnimMap5 <frequency> <image1> .... <imageN>
		//
		...
		//
		// clampAnimMap6 <frequency> <image1> .... <imageN>
		//
		else if ( !Q_stricmp( token, "clampAnimMap" ) )
		{
			int	totalImages = 0;
		...
		//
		// clampAnimMap7 <frequency> <image1> .... <imageN>
		//
		...
		else if ( !Q_stricmp( token, "videoMap2" ) )
		{
			...
			if (stage->bundle[2].videoMapHandle != -1) {
				...
				stage->bundle[2].image[0] = tr.scratchImage[stage->bundle[0].videoMapHandle];
			} else {
				ri.Printf( PRINT_WARNING, "WARNING: could not load '%s' for 'videoMap' keyword in shader '%s'\n", token, shader.name );
			}
		}
		...
		else if ( !Q_stricmp( token, "videoMap3" ) )
		{
			...
			if (stage->bundle[3].videoMapHandle != -1) {
				...
				stage->bundle[3].image[0] = tr.scratchImage[stage->bundle[0].videoMapHandle];
			} else {
				ri.Printf( PRINT_WARNING, "WARNING: could not load '%s' for 'videoMap' keyword in shader '%s'\n", token, shader.name );
			}
		}
		...
		else if ( !Q_stricmp( token, "videoMap4" ) )
		{
			...
			if (stage->bundle[4].videoMapHandle != -1) {
				...
				stage->bundle[4].image[0] = tr.scratchImage[stage->bundle[0].videoMapHandle];
			} else {
				ri.Printf( PRINT_WARNING, "WARNING: could not load '%s' for 'videoMap' keyword in shader '%s'\n", token, shader.name );
			}
		}
		...
		else if ( !Q_stricmp( token, "videoMap5" ) )
		{
			...
			if (stage->bundle[5].videoMapHandle != -1) {
				...
				stage->bundle[5].image[0] = tr.scratchImage[stage->bundle[0].videoMapHandle];
			} else {
				ri.Printf( PRINT_WARNING, "WARNING: could not load '%s' for 'videoMap' keyword in shader '%s'\n", token, shader.name );
			}
		}
		...
		else if ( !Q_stricmp( token, "videoMap6" ) )
		{
			...
			if (stage->bundle[6].videoMapHandle != -1) {
				...
				stage->bundle[6].image[0] = tr.scratchImage[stage->bundle[0].videoMapHandle];
			} else {
				ri.Printf( PRINT_WARNING, "WARNING: could not load '%s' for 'videoMap' keyword in shader '%s'\n", token, shader.name );
			}
		}
		...
		else if ( !Q_stricmp( token, "videoMap" ) )
		{
			...
			if (stage->bundle[7].videoMapHandle != -1) {
				...
				stage->bundle[7].image[0] = tr.scratchImage[stage->bundle[0].videoMapHandle];
			} else {
				ri.Printf( PRINT_WARNING, "WARNING: could not load '%s' for 'videoMap' keyword in shader '%s'\n", token, shader.name );
			}
		}
