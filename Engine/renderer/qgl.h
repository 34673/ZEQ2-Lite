...
#define QGL_1_1_PROCS \
	...
	GLE(void, CopyTexImage2D, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) \
	...
	GLE(void, Fogfv, GLenum pname, GLfloat* params) \
	...
	GLE(void, TexParameterfv, GLenum target, GLenum pname, GLfloat* params) \
