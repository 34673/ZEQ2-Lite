...
RGL1DIR=Engine/renderergl1
RGL2DIR=Engine/renderergl2
CMDIR=Shared
SDLDIR=Engine/sdl
ASMDIR=Engine/asm
SYSDIR=Engine/sys
...
OGGDIR=Engine/libogg-1.3.2
VORBISDIR=Engine/libvorbis-1.3.5
OPUSDIR=Engine/LibOpusCodec
OPUSFILEDIR=Engine/LibOpusFile
ZDIR=Engine/Zlib
